...
$rs = mysql_query("SELECT * FROM orcdiversos WHERE CodOrcDiverso = '$id'");
        ...
        <div class="box">
            ...
            <div class="title">
                <h4>
                    ...
                    <span>Editar Diversos</span>
                </h4>
            </div>
            <div class="content">
                <form class="form-horizontal" action="action/orcamentos.php" method="post">
                    <input type="hidden" name="do" value="AlteraDiversos" />
                    ...
                    <div class="form-actions">
                       ...
                       <button type="button" class="btn" onclick="location.href='?s=orcamentos-produtos&id=<?=$id_orcamento?>#diversos'">Cancelar</button>
                    </div>
                </form>
            </div>
        </div><!-- End .box -->
