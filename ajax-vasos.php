...
$result = mysql_query("SELECT COUNT(*) AS count
    ...
    AND vasos.Modelo LIKE '%$searchTerm%'
...
if($total_pages!=0)
    ...
    $SQL = "SELECT vasos.*, fornecedores.Nome nomeFornecedor, DATE_FORMAT( vasos.DataCadastra,'%d/%m/%Y') as dataCad, revestimentos.Descricao
            FROM vasos, fornecedores, revestimentos
            WHERE vasos.CodFornecedor = fornecedores.CodFornecedor
            AND vasos.CodRevestimento = revestimentos.CodRevestimento
            AND vasos.Modelo LIKE '%$searchTerm%'
