	...
	$('#produto_vegetais').click(function(){
        if($('#produto_busca').is(':checked')) {
            $('#produto_vegetais').combogrid({
                ...
                debug:false,
                colModel: [
                    {'columnName':'DataCadastra','width':'10','label':'Data'},
                    {'columnName':'Produto','width':'10','label':'Nome'},
                    {'columnName':'NFornecedor','width':'15','label':'Fornecedor'},
                    //{'columnName':'Poda','width':'10','label':'Poda'},
                    {'columnName':'Sigla','width':'5','label':'Un'},
                    {'columnName':'Porte','width':'10','label':'Porte'},
                    {'columnName':'Diametro','width':'10','label':'Diam. Tr'},
                    {'columnName':'Altura','width':'10','label':'Alt. Tr'},
                    {'columnName':'Valor','width':'5','label':'R$'},
                    {'columnName':'Unidades','width':'10','label':'Un. Cx'},
                    {'columnName':'Cor','width':'10','label':'Cor'},
                    ],
