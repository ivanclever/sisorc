...
$rs = mysql_query("SELECT * FROM orcespeciesvegetais WHERE CodOrcEspecieVegetal = '$id'");
        ...
        <div class="box">
            ...
            <div class="title">
                <h4>
                    ...
                    <span>Editar Espécies Vegetais</span>
                </h4>
            </div>
            <div class="content">
                <form class="form-horizontal" action="action/orcamentos.php" method="post">
                    <input type="hidden" name="do" value="AlteraVegetais" />
                    ...
                    <div class="form-actions">
                       ...
                       <button type="button" class="btn" onclick="location.href='?s=orcamentos-produtos&id=<?=$id_orcamento?>'">Cancelar</button>
                    </div>
                </form>
            </div>
        </div><!-- End .box -->
